    ...
    <div className="fe">
      <div className="f-right">
        ...
        <div className="f-links">
          <a href="#" className="myButton-fe">
            call
          </a>
          <a href="#" className="myButton-ge">
            About
          </a>
          <a href="#" className="myButton-he">
            Work
          </a>
        </div>
      </div>
      <div className="f-right">
        ...
        <div className="f-pro-links">
          <p className="f-par">
            ...
            &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; GSP
            STUDIO, skip gallery, self space, <br />
            &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
            &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
          ...
          <p className="f-par-3">
            ...
            &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
            Angelia betty, dolly nice
          </p>

          <br />
          <br />

          <a href="#" className="f-fashion">
            Calvin fashion
          </a>
        </div>
      ...
      <div className="f-left">
        <Image src={F} alt="Hey ! I am a image" className="f-for" />
        <Image src={G} alt="Hey ! I am a image" className="f-fore" />
      </div>
      <div className="f-l-section">
        <h1 className="f-l-title-ex">EXPLORATION</h1>

        <p className="f-l-para">
          FEEL LIBRARY is a three week immersive pop up, designed to <br />
          help us check in with our big, sometimes messy feelings and <br />
          concert with others within the creative space of a skip.
        </p>
      </div>

      <a href="#" className="f-ad">
        Flexiable access to private
      </a>
    </div>
  );
};
